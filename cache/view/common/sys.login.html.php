...
.loginbox .tit{float:left;width:280px;height:36px;background:url(/webcss/common/images/bg_1.jpg) no-repeat;text-align:left;font-weight:bold;padding:9px 0px 0px 53px}
...
<div class="loginbox">
	...
	<div class="logintab">
		...
		<tr><td>用户名：</td><td><div id="id_verify" style="display:none" onmouseover="kj.show(this);"><img src="/webcss/common/" id="id_verify_pic" onclick="this.src='<?php echo cls_config::get("url","base");?>/common.php?app=sys&app_act=verifycode&app_contenttype=img&app_rnd='+Math.random();"></div><input type="text" name="uname" value="" class="pTxt1 pTxtL200" onfocus="kj.hide('#id_verify');"></td></tr>
