...
<div class="right" id="id_right">
	<li class="pic"><span><img src="<?php echo cls_config::get("shop_logo","view");?>">&nbsp;</span><a href="javascript:window.external.AddFavorite(location.href,document.title);" class="xcollect">收藏</a></li>
	<li class="info"><span class='xtit'><?php echo cls_config::get("shop_name","view");?></span><span><font color="#666666">餐品：</font><?php echo $shop_menunum;?></span><span><a href="javascript:jsheader.comment_shop()"><font color="#666666">评论：</font><?php echo $shop_commentnum;?></span></a></li>
